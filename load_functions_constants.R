...
## Constants ## ---------------------------------------------------
site.release = c("lon" =  -102.300687 , "lat" =  32.053111)
site.flare = c("lon" =  -102.2897 , "lat" = 32.056)
Earth_radius = 6378137 # meters
  # load color palette 
load("/Users/apisada/Documents/R_scripts/heat.275.RData")
#print("HIIIIIIII")
source("/Users/apisada/Google Drive/My Drive/Research/Harvard_Research/MethaneAIR/Scripts/functions/moments.fcn2.r")
## functions ## ---------------------------------------------------
...
emission.cal.IME = function(wind = 0,ime_input = 0, area_input = 0) {
  #mass_str = paste("total.mass.", source.type, ".2", sep = "")
  IME =  ime_input #Summary_J.2[ current_summary, mass_str] 
  U_eff = log(wind) + 0.6 #m/s
  #area_str =  paste("area.", source.type, ".m2.2", sep = "")
