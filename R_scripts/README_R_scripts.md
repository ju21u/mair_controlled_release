...
| 20211101_load_data_temp.R       | Temporary or exploratory loading of observational data; could serve as a staging area. |
| 20220111_clean_extents.R        | Cleans or adjusts spatial extents for analysis (e.g., bounding boxes or rasters). |
| 20230201_clean_1x1_new_bg.R     | Processes 1x1 km grid rasters with a new background estimate method. |
| 20230207_clean_1x1_flare_release.R | Cleans or reshapes raster scenes for flare release events (likely linked to controlled tests). |
| 20230222_clean_1x1_RF04.R       | Specific spatial cleaning script for RF04's 1x1 km rasters. |
| 20230328_clean_1x1_FLARE.R      | Final cleaning step for scenes involving flare-related emissions. |
| 20230328_clean_1x1_releaseE.R   | Prepares scenes for "release E" (another controlled release event). |
...
| Script                    | Purpose                                                                 |
|---------------------------|-------------------------------------------------------------------------|
| estimate_emissions_v11.R | Most recent version of the main emissions estimation pipeline. Uses cropped scenes, wind, and pressure data. |
